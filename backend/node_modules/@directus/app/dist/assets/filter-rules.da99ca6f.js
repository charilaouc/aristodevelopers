...
`)])]),l("p",null,[t("the top level parent will be returned if "),l("em",null,"one of"),t(" the categories has the name "),l("code",null,"Recipe"),t(". This behavior can be overridden by using the explicit "),l("code",null,"_some"),t(" and "),l("code",null,"_none"),t(" operators, for example:")]),l("pre",null,[l("code",{class:"language-json"},[t(`{
	`),l("span",{class:"hljs-attr"},'"categories"'),t(`: {
